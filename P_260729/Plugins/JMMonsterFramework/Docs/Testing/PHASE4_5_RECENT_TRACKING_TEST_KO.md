...
Automation 창에서 `JM.MonsterFramework.Phase5.BuildAndValidatePredictiveStateTree`, `JM.MonsterFramework.Phase1.SightStateTransitions`, `JM.MonsterFramework.Phase0.SimpleEnemyDefaults`를 실행한다.
...
6. 끝까지 숨은 채 `RecentTracking -> InvestigateLastLocation -> Search -> Patrol` 순서를 확인한다.
