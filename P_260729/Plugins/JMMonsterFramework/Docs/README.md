---
title: "JMMonsterFramework Phase 6"
status: Current
authority: Guide
scope: "JMMonsterFramework Phase 0-6 setup and usage"
...
# JMMonsterFramework Phase 6

현재 범위는 Enemy 자동 Possession, NavMesh Patrol, 플레이어 Sight, Chase, Basic Attack, 선택 가능한 Lost Sight Tracking, 마지막 관측 위치 조사와 유한 Search다.
...
- `ST_SimpleEnemy`: `Patrol`, `Chase`, `Attack`, `RecentTracking`, `InvestigateLastLocation`, `Search`
- `ST_SimpleEnemy_LiveGrace`: `Patrol`, `Chase`, `Attack`, `LiveGraceTracking`, `InvestigateLastLocation`, `Search`
...
Combo, Special Attack, Ability/Animation Framework, Hearing, 장기 Memory와 범용 예측 시스템은 포함되지 않는다.
