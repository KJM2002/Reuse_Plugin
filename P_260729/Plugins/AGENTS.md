...
| `JMMonsterFramework` | `JMMonsterFrameworkRuntime`, `JMMonsterFrameworkTests` | 자동 Possession, Sight, StateTree Chase, 마지막 위치 조사, 유한 Search | 없음 | 독립 Runtime + Editor Tests, Content 포함 |
