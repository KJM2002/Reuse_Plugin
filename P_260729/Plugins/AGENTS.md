...
| `JMMonsterFramework` | `JMMonsterFrameworkRuntime`, `JMMonsterFrameworkTests` | Phase 0 자동 Possession과 Phase 1 플레이어 Sight 상태 감지 | 없음 | 독립 Runtime + Editor Tests, Content 가능 |
