...
1. [프로토타입 시스템](Systems/Prototype/PROTOTYPE_SYSTEMS_KO.md)
2. [포탈 전환 연출](Systems/Prototype/PROTOTYPE_PORTAL_TRANSITION_KO.md)
3. [프로토타입 플레이테스트](Testing/PROTOTYPE_PLAYTEST_KO.md)

이 세 문서는 현재 `ReviewRequired`다. 코드·맵·입력과 다시 검증하기 전에는 구현의 최종 기준으로 사용하지 않는다.
...
| JMMonsterFramework | 1.1.0 | [README](../Plugins/JMMonsterFramework/Docs/README.md) | 분류 완료, 내용 재검증 필요 |
